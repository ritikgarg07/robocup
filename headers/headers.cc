...
EnumParser<SkillType>::EnumParser()
{
    ...
    /*string2enum["SKILL_KICK_LEFT_LEG_PASS"] = SKILL_KICK_LEFT_LEG_PASS;
    enum2String[SKILL_KICK_LEFT_LEG_PASS] = "SKILL_KICK_LEFT_LEG_PASS";

    string2enum["SKILL_KICK_RIGHT_LEG_PASS"] = SKILL_KICK_RIGHT_LEG_PASS;
    enum2String[SKILL_KICK_RIGHT_LEG_PASS] = "SKILL_KICK_RIGHT_LEG_PASS";
    */
