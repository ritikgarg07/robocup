...
EnumParser<SkillType>::EnumParser()
{
    ...
    string2enum["SKILL_LONG_KICK_LEFT_LEG"] = SKILL_LONG_KICK_LEFT_LEG;
    enum2String[SKILL_LONG_KICK_LEFT_LEG] = "SKILL_LONG_KICK_LEFT_LEG";

    string2enum["SKILL_LONG_KICK_RIGHT_LEG"] = SKILL_LONG_KICK_RIGHT_LEG;
    enum2String[SKILL_LONG_KICK_RIGHT_LEG] = "SKILL_LONG_KICK_RIGHT_LEG";

    string2enum["SKILL_DIVE_LEFT"] = SKILL_DIVE_LEFT;
    enum2String[SKILL_DIVE_LEFT] = "SKILL_DIVE_LEFT";

    string2enum["SKILL_DIVE_RIGHT"] = SKILL_DIVE_RIGHT;
    enum2String[SKILL_DIVE_RIGHT] = "SKILL_DIVE_RIGHT";
